...
penny/
  ...
  agents/
    ...
    self_state.py     — SelfStateHeader: renders Penny's operational self-state (active mechanisms · recent activity — runs, config mutations, and autonomous sends (#1568) interleaved · store map · skills and standing rules (#1471) · durable user facts) into the chat prompt's dynamic tail, deterministically from the registry + ledger (#1555, the ambient inversion)
